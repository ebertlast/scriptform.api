...
use App\Lib\Tokens;
use App\Model\UsgruhModel as Model;

$app->group('/detallegrupos/', function () {
    ...
    $this->get('{GrupoID}/{ProcedimientoID}/[{ControlID}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = $model->Registros($GrupoID,$ProcedimientoID,$ControlID);
        //endregion
    ...
    $this->delete('{GrupoID}/{ProcedimientoID}/{ControlID}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($GrupoID,$ProcedimientoID,$ControlID);
        //endregion
