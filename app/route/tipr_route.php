...
use App\Lib\Tokens;
use App\Model\TiprModel as Model;

$app->group('/parentescos/', function () {
    ...
    $this->get('[{TipoRelacionID}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($TipoRelacionID);
        //endregion
    ...
    $this->delete('{TipoRelacionID}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($TipoRelacionID);
        //endregion
