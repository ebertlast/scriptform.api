...
use App\Lib\Tokens;
use App\Model\TaeModel as Model;

$app->group('/tamanoempresa/', function () {
    ...
    $this->get('[{TamanoID}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        $token = $req->getAttribute('token');
        $TamanoID = isset($args['TamanoID']) ? $args['TamanoID'] : '';
        //endregion
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($TamanoID);
        //endregion
    ...
    $this->delete('{TamanoID}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($TamanoID);
        //endregion
