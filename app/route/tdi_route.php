...
use App\Lib\Tokens;
use App\Model\TdiModel as Model;

$app->group('/tipodiscapacidad/', function () {
    ...
    $this->get('[{TipoDiscapacidadId}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($TipoDiscapacidadId);
        //endregion
    ...
    $this->delete('{TipoDiscapacidadId}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($TipoDiscapacidadId);
        //endregion
