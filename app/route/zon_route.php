...
use App\Lib\Tokens;
use App\Model\ZonModel as Model;

$app->group('/zonas/', function () {
    ...
    $this->get('[{ZonaID}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        // $jwt = new Tokens();
        // $data = $jwt->decode($token);
        $ZonaID = isset($args['ZonaID']) ? $args['ZonaID'] : '';
        //endregion

        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($ZonaID);
        //endregion
    ...
    $this->delete('{ZonaID}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($ZonaID);
        //endregion
