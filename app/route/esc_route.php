...
use App\Lib\Tokens;
use App\Model\EscModel as Model;

$app->group('/nivelescolaridad/', function () {
    ...
    $this->get('[{Identificador}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        // $jwt = new Tokens();
        // $data = $jwt->decode($token);
        $Identificador = isset($args['Identificador']) ? $args['Identificador'] : '';
        //endregion

        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($Identificador);
        //endregion
    ...
    $this->delete('{Identificador}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($Identificador);
        //endregion
