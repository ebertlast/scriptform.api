...
use App\Lib\Tokens;
use App\Model\EciModel as Model;

$app->group('/estadocivil/', function () {
    ...
    $this->get('[{EstadoId}]', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        // $jwt = new Tokens();
        // $data = $jwt->decode($token);
        $EstadoId = isset($args['EstadoId']) ? $args['EstadoId'] : '';
        //endregion

        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->Registros($EstadoId);
        //endregion
    ...
    $this->delete('{EstadoId}', function ($req, $res, $args) {
        //region Firma del modelo de la clase
        try {
            $model = new Model();
        } catch (Exception $e) {
        ...
        //region Llamar el metodo del modelo para generar la respuesta
        $response = new Response();
        $response = $model->EliminarRegistro($EstadoId);
        //endregion
