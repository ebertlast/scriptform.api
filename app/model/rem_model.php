...
class RemModel
{
    ...
    public function Registros($RegimeEmpresaID = '')
    {
        try
        {
            ...
            $params = array(
                ...
                array(&$RegimeEmpresaID, SQLSRV_PARAM_IN),
            );
    ...
    public function NuevoRegistro($modelo)
    {
        try
        {
            $sqlString = "EXEC DBO.SPS_ABCS_REM @ACCION=?, @RegimeEmpresaID = ?, @DescripcionRegimenEmpresa = ?";
            $params = array(
                array('A', SQLSRV_PARAM_IN),
                array(&$modelo['RegimeEmpresaID'], SQLSRV_PARAM_IN),
                array(&$modelo['DescripcionRegimenEmpresa'], SQLSRV_PARAM_IN),
            );
    ...
    public function EliminarRegistro($RegimeEmpresaID, $DescripcionRegimenEmpresa)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_REM @ACCION=?, @RegimeEmpresaID=?";
            $params = array(
