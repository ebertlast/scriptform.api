...
class UsgruhModel
{
    ...
    public function Registros($GrupoID = '', $ProcedimientoID = '', $ControlID = '')
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_USGRUH @ACCION = ?";
            if ($GrupoID != '') {
                $query .= ", @GrupoID=?";
            }
            if ($ProcedimientoID != '') {
    ...
    public function EliminarRegistro($GrupoID, $ProcedimientoID, $ControlID)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_USGRUH @ACCION=?, @GrupoID=?, @ProcedimientoID=?, @ControlID=?";
            $params = array(
