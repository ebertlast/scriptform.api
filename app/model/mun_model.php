...
class MunModel
{
    ...
    /**
     * Obtiene todos los municipios o un municipio segun sea el caso de la tabla MUN
     *
     * @param string Id del Municipio
     * @return Response Objeto de la clase Response
     */
    public function Municipios($municipioid)
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_MUN @MunicipioID=?";
            $params = array(
