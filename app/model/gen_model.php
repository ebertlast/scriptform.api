...
class GenModel
{
    ...
    public function Registros($generoid = '')
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_GEN @GeneroID=?";
            $params = array(
                array(&$generoid, SQLSRV_PARAM_IN),
            );
    ...
    public function NuevoRegistro($modelo)
    {
        try
        {
            $sqlString = "EXEC DBO.SPS_ABCS_GEN @ACCION=?, @GeneroID = ?, @DescripcionGenero = ?, @LargoGenero = ?, @TipoDatoGenero = ?";
            $params = array(
                array('A', SQLSRV_PARAM_IN),
                array(&$modelo['GeneroID'], SQLSRV_PARAM_IN),
                array(&$modelo['DescripcionGenero'], SQLSRV_PARAM_IN),
                array(&$modelo['LargoGenero'], SQLSRV_PARAM_IN),
                array(&$modelo['TipoDatoGenero'], SQLSRV_PARAM_IN),
            );
    ...
    public function EliminarRegistro($GeneroID)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_GEN @ACCION=?, @GeneroID=?";
            $params = array(
