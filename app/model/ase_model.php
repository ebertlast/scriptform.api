...
class AseModel
{
    ...
    public function Registros($AsesorID = '')
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_ASE @ACCION = ?";
            if ($AsesorID != '') {
                $query .= ", @AsesorID=?";
            }
            $params = array(
                array('S', SQLSRV_PARAM_IN),
                array(&$AsesorID, SQLSRV_PARAM_IN),
            );
    ...
    public function NuevoRegistro($modelo)
    {
        try
        {
            $sqlString = "EXEC DBO.SPS_ABCS_ASE @ACCION=?, @AsesorID = ?, @NombreAsesor = ?, @AsesorIDAlterno = ?, @NombreAsesorAlterno = ?, @AsesorEstado = ?,";
            $params = array(
                array('A', SQLSRV_PARAM_IN),
                array(&$modelo['AsesorID'], SQLSRV_PARAM_IN),
                array(&$modelo['NombreAsesor'], SQLSRV_PARAM_IN),
                array(&$modelo['AsesorIDAlterno'], SQLSRV_PARAM_IN),
                array(&$modelo['NombreAsesorAlterno'], SQLSRV_PARAM_IN),
                array(&$modelo['AsesorEstado'], SQLSRV_PARAM_IN),
            );
    ...
    public function EliminarRegistro($AsesorID)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_ASE @ACCION=?, @AsesorID=?";
            $params = array(
