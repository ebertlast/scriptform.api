...
class UsproModel
{
    ...
    public function Registros($ProcedimientoID = '')
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_USPRO @ACCION = ?";
            if ($ProcedimientoID != '') {
    ...
    public function NuevoRegistro($modelo)
    {
        try
        {
            $sqlString = "EXEC DBO.SPS_ABCS_USPRO @ACCION=?, @ProcedimientoID = ?, @DescripcionProcedimiento = ?";
            $params = array(
                array('A', SQLSRV_PARAM_IN),
                array(&$modelo['ProcedimientoID'], SQLSRV_PARAM_IN),
                array(&$modelo['DescripcionProcedimiento'], SQLSRV_PARAM_IN),
            );
    ...
    public function EliminarRegistro($ProcedimientoID)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_USPRO @ACCION=?, @ProcedimientoID=?";
            $params = array(
