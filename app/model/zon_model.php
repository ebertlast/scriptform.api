...
class ZonModel
{
    ...
    public function Registros($ZonaID = '')
    {
        try
        {
            $query = "EXEC dbo.SPS_ABCS_ZON @ZonaID=?";
            $params = array(
                array(&$ZonaID, SQLSRV_PARAM_IN),
            );
    ...
    public function NuevoRegistro($modelo)
    {
        try
        {
            $sqlString = "EXEC DBO.SPS_ABCS_ZON @ACCION=?, @ZonaID = ?, @DescripcionZona = ?";
            $params = array(
                array('A', SQLSRV_PARAM_IN),
                array(&$modelo['ZonaID'], SQLSRV_PARAM_IN),
                array(&$modelo['DescripcionZona'], SQLSRV_PARAM_IN),
            );
    ...
    public function EliminarRegistro($ZonaID)
    {
        try
        {
            $sqlString = "EXEC dbo.SPS_ABCS_ZON @ACCION=?, @ZonaID=?";
            $params = array(
