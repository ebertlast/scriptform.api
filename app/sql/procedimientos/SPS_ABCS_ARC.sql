...
BEGIN
	...
	BEGIN
        ...
        IF ISNULL(@ASESORID,'')<>'' SET @SQLString=@SQLString+', ASESORID = '''+@ASESORID+''' '
	...
	BEGIN
        ...
        IF ISNULL(@ASESORID,'')<>'' SET @SQLString=@SQLString+' AND ASESORID = '''+@ASESORID+''' '
...
END
GO
EXEC dbo.SPS_ABCS_ARC --@FORMULARIOID = '1234567'
